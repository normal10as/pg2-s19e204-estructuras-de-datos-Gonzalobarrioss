...
Module Program
    Private bandera_nombres, nombre_mejores_alumnos, lista_total As String
    Sub Main(args As String())
        ...
        For i = 0 To cant_alu
            bandera_nombres = validarNombre()
            matriz(i, 0) = nombreIgual(matriz, bandera_nombres)
    ...
    Function nombreIgual(matriz(,), nombre) As String
        For x = 0 To matriz.GetUpperBound(1)
            If matriz(x, 0) = nombre Then
                Console.WriteLine("Ese nombre ya existe, ingrese otro.")
                nombre = validarNombre()
                nombreIgual(matriz, nombre)
            End If
        Next
